...
export async function POST(request: Request) {
  ...
  const session = await createClimbingSession(user.id, { title: body.title, date: body.date, time: body.time, location: body.location, projectId: typeof body.projectId === "string" ? body.projectId : undefined });
