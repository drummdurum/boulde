...
const projects = [
  { id: "p1", name: "Nordlys", location: "Kjugekull", grade: "7A+" as const, attempts: 12, lastAttempt: "I går", note: "Test", status: "Tæt på" as const, progress: 82, visible: false },
  { id: "p2", name: "Kalk & kaffe", location: "Sydhavn", grade: "7A" as const, attempts: 7, lastAttempt: "I går", note: "Test", status: "Arbejder på den" as const, progress: 55, visible: false },
];
