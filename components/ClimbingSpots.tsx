...
export function ClimbingSpots({ spots }: { spots: ClimbingSpot[] }) {
  return <section aria-labelledby="spots-title">
    <div className="mb-4 flex items-end justify-between"><div><p className="text-xs font-extrabold uppercase tracking-[.16em] text-clay">I nærheden</p><h2 id="spots-title" className="mt-1 text-xl font-extrabold text-ink">Populære steder</h2></div><Link href="/steder"><Button variant="ghost" size="sm" aria-label="Se alle klatresteder"><ArrowRight size={17} /></Button></Link></div>
